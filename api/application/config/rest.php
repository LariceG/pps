...
// $config['auth_override_class_method_http']['wildcard_test_cases']['*']['options'] = 'basic';
 ...
 $config['auth_override_class_method_http']['WebServices']['login']['post'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['forgotPassword']['put'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['productListing']['post'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['getCatss']['get'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['getProductDetail']['get'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['getUnAssignedStores']['get'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['getUnAssignedStoresExApl']['get'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['requestStoreAccess']['post'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['getWhere']['get'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['getCatsdata']['get'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['downloadOrderPdf']['get'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['changePassword']['post'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['getLimit']['get'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['getPortalOrders']['get'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['aplAlter']['get'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['uploadFile']['post'] = 'none';
 $config['auth_override_class_method_http']['WebServices']['getSettings']['get'] = 'none';
...
/*
  ...
  |
 */
$config['rest_keys_table'] = 'pps_api_keys';
 ...
 */
$config['rest_userid_column'] = 'userRefId';
...
/*
  ...
  |
 */
$config['rest_logs_table'] = 'pps_api_logs';
