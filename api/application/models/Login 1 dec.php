...
class Login extends CI_Model {
    ...
    function clientApiLogin($username = NULL, $password = NULL, $usertype = NULL)
	{
        ...
        if ($username != NULL && $password != NULL)
		{
			...
			{
				$query .= " WHERE (user.userName=" . $username . " OR user.userEmail=" . $username . ") AND user.userPassword= " . $password . " AND ( user.userType = 3 or user.userType = 4 ) ".$status ;
			}
			else
			{
...
####################################################################
	...
	{
		$this->db->select('prds.productCode, prds.productName, prds.productDescription, prds.productImage, prds.productPrice, prds.productCategory');
	...
	{
			$this->db->select('ppcadd.bkId,ppcadd.userId,ppcadd.productId,ppcadd.quantity,prds.productCode, prds.productName, prds.productDescription, prds.productImage, prds.productPrice, prc.catName,vars.productVarDesc');
	...
	public function saveAddTocartMyOrders($userId,$productId,$qty,$varid)
	{
		$orderDatas = array(
				'userId'=>$userId,
				'productId'=>$productId,
	...
	public function saveMyOrders($userId)
	{
		$rand 				= rand(0,9999);
