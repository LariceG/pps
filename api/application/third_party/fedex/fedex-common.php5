...
function getProperty($var){
  ...
  if($var == 'key') Return 'sMMgUDHHMg4weyKI';
	if($var == 'password') Return 'WLKgkmLrI032eoP35F7utRvwY';
	if($var == 'parentkey') Return 'sMMgUDHHMg4weyKI';
	if($var == 'parentpassword') Return 'WLKgkmLrI032eoP35F7utRvwY';
...
if (!function_exists('setEndpoint')) {
function setEndpoint($var){
	if($var == 'changeEndpoint') Return false;
	if($var == 'endpoint') Return 'XXX';
}
}
if (!function_exists('printNotifications')) {
...
if (!function_exists('trackDetails')) {
