...
const routes: Routes = [
  ...
  { path: 'admin-panel/add-apdms', component: AddapdmsComponent ,canActivate: [AuthGuardSuperAdmin]},
  { path: 'admin-panel/list-apdms', component: ListapdmComponent ,canActivate: [AuthGuardSuperAdmin]},
  ...
  { path: 'dashboard/list-apdms', component: PortalListApdmsComponent ,canActivate: [AuthGuard]},
