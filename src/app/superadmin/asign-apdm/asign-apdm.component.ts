...
@Component({
  ...
  templateUrl: './asign-apdm.component.html',
  styleUrls: ['./asign-apdm.component.css'],
  providers: [SuperadminService]
})

export class AsignApdmComponent implements OnInit {
  @Input() Apdm: string;
  protected dataService: CompleterData;
  clickedObj = {};
  AssignedStores : object = [];
  ...
  getAssignes()
  {
    this._sp.getAssignes(this.Apdm).subscribe(
      data => {
        if(data.success)
        {
